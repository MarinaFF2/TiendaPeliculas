...
//            }
    ...
    public ArrayList<Peliculas> buscarPrecio(String name) {
        ArrayList<Peliculas> listaPelis = new ArrayList<Peliculas>();
        //como se reutiliza la variable la ponemos a null
        pelis = null;

        //consulta
        String sql = "SELECT DISTINCT * FROM peliculas WHERE precio LIKE '%" + name + "%'";
        ...
        try {
            ...
            //process the resulset with the methos resul.next()
            if (!resul.next()) {
                JOptionPane.showMessageDialog(null, "No hay películas con esa característica", "No se encuentra", JOptionPane.INFORMATION_MESSAGE);
            } else {
                while (resul.next()) {
                    pelis = new Peliculas(resul.getInt(1), resul.getString(2), resul.getString(3), resul.getInt(4), resul.getString(5), resul.getString(6), resul.getString(7), resul.getString(8), resul.getDouble(9));
                    listaPelis.add(pelis);
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Error al buscar por precio", "Error", JOptionPane.ERROR_MESSAGE);
        }

        return listaPelis;
    }

    public ArrayList<Peliculas> buscarRangoEdad(String name) {
        ArrayList<Peliculas> listaPelis = new ArrayList<Peliculas>();
        //como se reutiliza la variable la ponemos a null
        pelis = null;

        //consulta
        String sql = "SELECT DISTINCT * FROM peliculas WHERE RANGO_EDAD LIKE '%" + name + "%'";
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Error al buscar por RANGO_EDAD", "Error", JOptionPane.ERROR_MESSAGE);
        }

        return listaPelis;
    }

    public ArrayList<Peliculas> buscarGenero(String name) {
        ArrayList<Peliculas> listaPelis = new ArrayList<Peliculas>();
        //como se reutiliza la variable la ponemos a null
        pelis = null;
        //consulta
        String sql = "SELECT DISTINCT * FROM peliculas WHERE genero LIKE '%" + name + "%'";
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Error al buscar por genero", "Error", JOptionPane.ERROR_MESSAGE);
        }

        return listaPelis;
    }

    public ArrayList<Peliculas> buscarAnio(String name) {
        ArrayList<Peliculas> listaPelis = new ArrayList<Peliculas>();
        //como se reutiliza la variable la ponemos a null
        pelis = null;

        //consulta
        String sql = "SELECT DISTINCT * FROM peliculas WHERE anio LIKE '%" + name + "%'";
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Error al buscar por anio", "Error", JOptionPane.ERROR_MESSAGE);
        }

        return listaPelis;
    }

    public ArrayList<Peliculas> buscarDirector(String name) {
        ArrayList<Peliculas> listaPelis = new ArrayList<Peliculas>();
        //como se reutiliza la variable la ponemos a null
        pelis = null;

        //consulta
        String sql = "SELECT DISTINCT * FROM peliculas WHERE DIRECTOR LIKE '%" + name + "%'";
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Error al buscar por DIRECTOR", "Error", JOptionPane.ERROR_MESSAGE);
        }

        return listaPelis;
    }

    public ArrayList<Peliculas> buscarTitulo(String name) {
        ArrayList<Peliculas> listaPelis = new ArrayList<Peliculas>();
        //como se reutiliza la variable la ponemos a null
        pelis = null;

        //consulta
        String sql = "SELECT DISTINCT * FROM peliculas WHERE titulo LIKE '%" + name + "%'";
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Error al buscar por título", "Error", JOptionPane.ERROR_MESSAGE);
        }
